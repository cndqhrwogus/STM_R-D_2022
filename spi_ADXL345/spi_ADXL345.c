...
void adxl_write (uint8_t address, uint8_t value)
{
	...
	data[1] = value;
	HAL_GPIO_WritePin (GPIOA, GPIO_PIN_0, GPIO_PIN_RESET); // pull the cs pin low to enable the slave
	HAL_SPI_Transmit (&hspi1, data, 2, 100);  // transmit the address and data
	HAL_GPIO_WritePin (GPIOA, GPIO_PIN_0, GPIO_PIN_SET); // pull the cs pin high to disable the slave
}
